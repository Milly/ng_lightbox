...
ngLightbox.data = {
	...
	// Global css.
	styleSheet :[
		'#ngLightboxOverlay, #ngLightboxOverlay * { margin:0; padding:0; border:0 none; }',
		...
		'#ngLightboxMenu { position:fixed; bottom:-35px; left:0; width:100%; height:53px; z-index:10000100; background-color:#000; text-align:center; font-family:"Terbuchet MS", Tahoma, Arial, Verdana, sans-serif; overflow:hidden; white-space:nowrap; opacity:0.2; }',
		'.ngLightboxSlideShow #ngLightboxMenu { opacity:0; }',
		'#ngLightboxMenu:hover { bottom:0 !important; opacity:0.9; }',
		'#ngLightboxCaption { width:100%; height:18px; line-height:18px; font-size:12px; z-index:10000400; color:#aaa; }',
		'#ngLightboxButtons { height:35px; line-height:33px; font-size:18px; z-index:10000400; }',
		'#ngLightboxButtons a { display:inline-block; min-width:33px; height:33px; border:1px solid #000; -moz-border-radius:5px; cursor:pointer; text-align:center; color:#aaa; text-decoration:none; z-index:10000450; }',
		'#ngLightboxButtons a:hover { border-color:orange; background-color:#333; color:#fff; }',
		...
		'#ngLightboxButtonContext, #ngLightboxExButtons a { padding:0 0.5em; font-size:14px; }',
		...
		'#ngLightboxLeftArrow, #ngLightboxRightArrow { position:absolute; left:0; top:0; max-width:100px; width:20%; height:100%; }',
